...
class Product extends CI_Model {
	...
	{
		return $this->db->query("SELECT products.id, images.src AS img, products.name, inventory, sold FROM products LEFT JOIN images ON products.id=images.product_id")->result_array();
	}
